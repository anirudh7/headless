...
/** Input for the createItsnzSpeaker mutation */
export interface CreateItsnzSpeakerInput {
  /** The userId to assign as the author of the object */
  authorId?: InputMaybe<Scalars["ID"]>;
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars["String"]>;
...
/** Input for the deleteItsnzSpeaker mutation */
export interface DeleteItsnzSpeakerInput {
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars["String"]>;
  /** Whether the object should be force deleted instead of being moved to the trash */
  forceDelete?: InputMaybe<Scalars["Boolean"]>;
  /** The ID of the itsnzSpeaker to delete */
  id: Scalars["ID"];
}
...
/** The Type of Identifier used to fetch a single resource. Default is ID. */
export enum ItsnzSpeakerIdType {
  /** Identify a resource by the Database ID. */
  DATABASE_ID = "DATABASE_ID",
  /** Identify a resource by the (hashed) Global ID. */
  ID = "ID",
...
export interface RootQueryToEventConnectionWhereArgs {
  /** The user that's connected as the author of the object. Use the userId for the author object. */
  author?: InputMaybe<Scalars["Int"]>;
  /** Find objects connected to author(s) in the array of author's userIds */
  authorIn?: InputMaybe<Array<InputMaybe<Scalars["ID"]>>>;
...
/** Arguments for filtering the RootQueryToItsnzSpeakerConnection connection */
export interface RootQueryToItsnzSpeakerConnectionWhereArgs {
  /** The user that's connected as the author of the object. Use the userId for the author object. */
  author?: InputMaybe<Scalars["Int"]>;
  /** Find objects connected to author(s) in the array of author's userIds */
  authorIn?: InputMaybe<Array<InputMaybe<Scalars["ID"]>>>;
...
/** Input for the updateItsnzSpeaker mutation */
export interface UpdateItsnzSpeakerInput {
  /** The userId to assign as the author of the object */
  authorId?: InputMaybe<Scalars["ID"]>;
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars["String"]>;
  /** The date of the object. Preferable to enter as year/month/day (e.g. 01/31/2017) as it will rearrange date as fit if it is not specified. Incomplete dates may have unintended results for example, "2017" as the input will use current date with timestamp 20:17  */
  date?: InputMaybe<Scalars["String"]>;
  /** The ID of the itsnzSpeaker object */
  id: Scalars["ID"];
  /** A field used for ordering posts. This is typically used with nav menu items or for special ordering of hierarchical content types. */
  menuOrder?: InputMaybe<Scalars["Int"]>;
  /** The password used to protect the content of the object */
...
export interface UserToEventConnectionWhereArgs {
  /** The user that's connected as the author of the object. Use the userId for the author object. */
  author?: InputMaybe<Scalars["Int"]>;
  /** Find objects connected to author(s) in the array of author's userIds */
  authorIn?: InputMaybe<Array<InputMaybe<Scalars["ID"]>>>;
...
/** Arguments for filtering the UserToItsnzSpeakerConnection connection */
export interface UserToItsnzSpeakerConnectionWhereArgs {
  /** The user that's connected as the author of the object. Use the userId for the author object. */
  author?: InputMaybe<Scalars["Int"]>;
  /** Find objects connected to author(s) in the array of author's userIds */
  authorIn?: InputMaybe<Array<InputMaybe<Scalars["ID"]>>>;
...
export const generatedSchema = {
  ...
  CreateItsnzSpeakerPayload: {
    __typename: { __type: "String!" },
    clientMutationId: { __type: "String" },
    itsnzSpeaker: { __type: "ItsnzSpeaker" },
  },
  ...
  DeleteItsnzSpeakerInput: {
    clientMutationId: { __type: "String" },
    forceDelete: { __type: "Boolean" },
    id: { __type: "ID!" },
  },
  DeleteItsnzSpeakerPayload: {
    __typename: { __type: "String!" },
    clientMutationId: { __type: "String" },
    deletedId: { __type: "ID" },
    itsnzSpeaker: { __type: "ItsnzSpeaker" },
  ...
  Event: {
    ...
    eventId: { __type: "Int!" },
    eventName: { __type: "String" },
    eventSpeakers: {
      __type: "EventToItsnzSpeakerConnection",
      __args: { after: "String", before: "String", first: "Int", last: "Int" },
    },
    guid: { __type: "String" },
    id: { __type: "ID!" },
    ...
    modified: { __type: "String" },
    modifiedGmt: { __type: "String" },
    preview: { __type: "EventToPreviewConnectionEdge" },
    previewRevisionDatabaseId: { __type: "Int" },
    previewRevisionId: { __type: "ID" },
    slug: { __type: "String" },
    status: { __type: "String" },
  ...
  EventToItsnzSpeakerConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[EventToItsnzSpeakerConnectionEdge]" },
    nodes: { __type: "[ItsnzSpeaker]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  EventToItsnzSpeakerConnectionEdge: {
    __typename: { __type: "String!" },
    cursor: { __type: "String" },
    node: { __type: "ItsnzSpeaker" },
  },
  ...
  ItsnzSpeaker: {
    ...
    isRestricted: { __type: "Boolean" },
    isTermNode: { __type: "Boolean!" },
    itsnzSpeakerId: { __type: "Int!" },
    lastEditedBy: { __type: "ContentNodeToEditLastConnectionEdge" },
    link: { __type: "String" },
    modified: { __type: "String" },
    modifiedGmt: { __type: "String" },
    preview: { __type: "ItsnzSpeakerToPreviewConnectionEdge" },
    previewRevisionDatabaseId: { __type: "Int" },
    previewRevisionId: { __type: "ID" },
    slug: { __type: "String" },
    speakerBio: { __type: "String" },
    speakerCompany: { __type: "String" },
    speakerImage: { __type: "MediaItem" },
    speakerJobPosition: { __type: "String" },
    speakerName: { __type: "String" },
    speakerRole: { __type: "String" },
    status: { __type: "String" },
    template: { __type: "ContentTemplate" },
    templates: { __type: "[String]" },
    title: {
  ...
  ItsnzSpeakerToPreviewConnectionEdge: {
    __typename: { __type: "String!" },
    node: { __type: "ItsnzSpeaker" },
  },
  MediaDetails: {
  ...
  RootQueryToEventConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[RootQueryToEventConnectionEdge]" },
    nodes: { __type: "[Event]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  ...
  RootQueryToItsnzSpeakerConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[RootQueryToItsnzSpeakerConnectionEdge]" },
    nodes: { __type: "[ItsnzSpeaker]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  RootQueryToItsnzSpeakerConnectionEdge: {
    __typename: { __type: "String!" },
    cursor: { __type: "String" },
    node: { __type: "ItsnzSpeaker" },
  },
  RootQueryToItsnzSpeakerConnectionWhereArgs: {
    author: { __type: "Int" },
    authorIn: { __type: "[ID]" },
    authorName: { __type: "String" },
    authorNotIn: { __type: "[ID]" },
  ...
  User: {
    ...
    events: {
      __type: "UserToEventConnection",
      __args: {
        after: "String",
        before: "String",
        first: "Int",
        last: "Int",
        where: "UserToEventConnectionWhereArgs",
      },
    },
    ...
    isTermNode: { __type: "Boolean!" },
    itsnzSpeakers: {
      __type: "UserToItsnzSpeakerConnection",
      __args: {
        after: "String",
        before: "String",
        first: "Int",
        last: "Int",
        where: "UserToItsnzSpeakerConnectionWhereArgs",
      },
    },
    lastName: { __type: "String" },
    locale: { __type: "String" },
  ...
  UserToEventConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[UserToEventConnectionEdge]" },
    nodes: { __type: "[Event]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  UserToEventConnectionEdge: {
    __typename: { __type: "String!" },
    cursor: { __type: "String" },
    node: { __type: "Event" },
  },
  UserToEventConnectionWhereArgs: {
    author: { __type: "Int" },
    authorIn: { __type: "[ID]" },
    authorName: { __type: "String" },
    authorNotIn: { __type: "[ID]" },
  ...
  UserToItsnzSpeakerConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[UserToItsnzSpeakerConnectionEdge]" },
    nodes: { __type: "[ItsnzSpeaker]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  UserToItsnzSpeakerConnectionEdge: {
    __typename: { __type: "String!" },
    cursor: { __type: "String" },
    node: { __type: "ItsnzSpeaker" },
  },
  UserToItsnzSpeakerConnectionWhereArgs: {
    author: { __type: "Int" },
    authorIn: { __type: "[ID]" },
    authorName: { __type: "String" },
    authorNotIn: { __type: "[ID]" },
  ...
  mutation: {
    ...
    createEvent: {
      __type: "CreateEventPayload",
      __args: { input: "CreateEventInput!" },
    },
    createItsnzSpeaker: {
      __type: "CreateItsnzSpeakerPayload",
      __args: { input: "CreateItsnzSpeakerInput!" },
    },
    createMediaItem: {
    ...
    deleteEvent: {
      __type: "DeleteEventPayload",
      __args: { input: "DeleteEventInput!" },
    },
    deleteItsnzSpeaker: {
      __type: "DeleteItsnzSpeakerPayload",
      __args: { input: "DeleteItsnzSpeakerInput!" },
    },
    deleteMediaItem: {
    ...
    updateEvent: {
      __type: "UpdateEventPayload",
      __args: { input: "UpdateEventInput!" },
    },
    updateItsnzSpeaker: {
      __type: "UpdateItsnzSpeakerPayload",
      __args: { input: "UpdateItsnzSpeakerInput!" },
    },
    updateMediaItem: {
  ...
  query: {
    ...
    event: {
      __type: "Event",
      __args: { asPreview: "Boolean", id: "ID!", idType: "EventIdType" },
    },
    eventBy: {
      __type: "Event",
      __args: { eventId: "Int", id: "ID", slug: "String", uri: "String" },
    },
    events: {
      __type: "RootQueryToEventConnection",
      __args: {
        after: "String",
        before: "String",
        first: "Int",
    ...
    itsnzSpeaker: {
      __type: "ItsnzSpeaker",
      __args: { asPreview: "Boolean", id: "ID!", idType: "ItsnzSpeakerIdType" },
    },
    itsnzSpeakerBy: {
      __type: "ItsnzSpeaker",
      __args: {
    ...
    itsnzSpeakers: {
      __type: "RootQueryToItsnzSpeakerConnection",
      __args: {
        after: "String",
        before: "String",
        first: "Int",
        last: "Int",
        where: "RootQueryToItsnzSpeakerConnectionWhereArgs",
      },
    },
    mediaItem: {
      __type: "MediaItem",
  ...
  [SchemaUnionsKey]: {
    ...
    ContentNode: ["Event", "ItsnzSpeaker", "MediaItem", "Page", "Post"],
    NodeWithAuthor: ["Event", "ItsnzSpeaker", "MediaItem", "Page", "Post"],
    NodeWithTemplate: ["Event", "ItsnzSpeaker", "MediaItem", "Page", "Post"],
    NodeWithTitle: ["Event", "ItsnzSpeaker", "MediaItem", "Page", "Post"],
...
export interface ContentNode {
  __typename?: "Event" | "ItsnzSpeaker" | "MediaItem" | "Page" | "Post";
  /**
   * @deprecated Deprecated in favor of using Next.js pages
   */
  conditionalTags?: Maybe<ConditionalTags>;
...
/**
 * The payload for the createItsnzSpeaker mutation
 */
export interface CreateItsnzSpeakerPayload {
  __typename?: "CreateItsnzSpeakerPayload";
  /**
   * If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions.
   */
  clientMutationId?: Maybe<ScalarsEnums["String"]>;
   ...
   * The Post object mutation type.
   */
  itsnzSpeaker?: Maybe<ItsnzSpeaker>;
}
...
/**
 * The payload for the deleteItsnzSpeaker mutation
 */
export interface DeleteItsnzSpeakerPayload {
  __typename?: "DeleteItsnzSpeakerPayload";
  /**
   * If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions.
   */
  clientMutationId?: Maybe<ScalarsEnums["String"]>;
...
export interface Event {
   ...
   */
  eventId: ScalarsEnums["Int"];
  eventName?: Maybe<ScalarsEnums["String"]>;
  /**
   * Connection between the event type and the itsnzSpeaker type
   */
  eventSpeakers: (args?: {
    /**
     * Cursor used along with the "first" argument to reference where in the dataset to get data
     ...
     */
    last?: Maybe<Scalars["Int"]>;
  }) => Maybe<EventToItsnzSpeakerConnection>;
  /**
   * The global unique identifier for this post. This currently matches the value stored in WP_Post-&gt;guid and the guid column in the &quot;post_objects&quot; database table.
   */
  guid?: Maybe<ScalarsEnums["String"]>;
 ...
 * Connection between the event type and the itsnzSpeaker type
 */
export interface EventToItsnzSpeakerConnection {
  __typename?: "EventToItsnzSpeakerConnection";
  /**
   * Edges for the EventToItsnzSpeakerConnection connection
   */
  edges?: Maybe<Array<Maybe<EventToItsnzSpeakerConnectionEdge>>>;
  /**
   * The nodes of the connection, without the edges
   */
  nodes?: Maybe<Array<Maybe<ItsnzSpeaker>>>;
  /**
   * Information about pagination in a connection.
   */
  pageInfo?: Maybe<WPPageInfo>;
 ...
 * An edge in a connection
 */
export interface EventToItsnzSpeakerConnectionEdge {
  __typename?: "EventToItsnzSpeakerConnectionEdge";
  /**
   * A cursor for use in pagination
   */
  cursor?: Maybe<ScalarsEnums["String"]>;
   ...
   * The item at the end of the edge
   */
  node?: Maybe<ItsnzSpeaker>;
}

/**
 * Connection between the event type and the event type
 */
export interface EventToPreviewConnectionEdge {
...
/**
 * The itsnzSpeaker type
 */
export interface ItsnzSpeaker {
  __typename?: "ItsnzSpeaker";
  /**
   * Connection between the NodeWithAuthor type and the User type
   */
  author?: Maybe<NodeWithAuthorToUserConnectionEdge>;
  ...
  guid?: Maybe<ScalarsEnums["String"]>;
  /**
   * The globally unique identifier of the itsnzspeaker object.
   */
  id: ScalarsEnums["ID"];
  /**
   * Whether the node is a Content Node
   ...
   * @deprecated Deprecated in favor of the databaseId field
   */
  itsnzSpeakerId: ScalarsEnums["Int"];
  /**
   * The user that most recently edited the node
   */
  lastEditedBy?: Maybe<ContentNodeToEditLastConnectionEdge>;
  ...
  modifiedGmt?: Maybe<ScalarsEnums["String"]>;
  /**
   * Connection between the itsnzSpeaker type and the itsnzSpeaker type
   */
  preview?: Maybe<ItsnzSpeakerToPreviewConnectionEdge>;
  /**
   * The database id of the preview node
   */
  previewRevisionDatabaseId?: Maybe<ScalarsEnums["Int"]>;
   ...
   */
  slug?: Maybe<ScalarsEnums["String"]>;
  speakerBio?: Maybe<ScalarsEnums["String"]>;
  speakerCompany?: Maybe<ScalarsEnums["String"]>;
  speakerImage?: Maybe<MediaItem>;
  speakerJobPosition?: Maybe<ScalarsEnums["String"]>;
  speakerName?: Maybe<ScalarsEnums["String"]>;
  speakerRole?: Maybe<ScalarsEnums["String"]>;
  /**
   * The current status of the object
   */
  status?: Maybe<ScalarsEnums["String"]>;
 ...
 * Connection between the itsnzSpeaker type and the itsnzSpeaker type
 */
export interface ItsnzSpeakerToPreviewConnectionEdge {
  __typename?: "ItsnzSpeakerToPreviewConnectionEdge";
  /**
   * The node of the connection, without the edges
   */
  node?: Maybe<ItsnzSpeaker>;
 ...
 */
export interface RootQueryToEventConnection {
 ...
 * An edge in a connection
 */
export interface RootQueryToEventConnectionEdge {
...
/**
 * Connection between the RootQuery type and the itsnzSpeaker type
 */
export interface RootQueryToItsnzSpeakerConnection {
  __typename?: "RootQueryToItsnzSpeakerConnection";
  /**
   * Edges for the RootQueryToItsnzSpeakerConnection connection
   */
  edges?: Maybe<Array<Maybe<RootQueryToItsnzSpeakerConnectionEdge>>>;
  /**
   * The nodes of the connection, without the edges
   */
  nodes?: Maybe<Array<Maybe<ItsnzSpeaker>>>;
 ...
 * An edge in a connection
 */
export interface RootQueryToItsnzSpeakerConnectionEdge {
  __typename?: "RootQueryToItsnzSpeakerConnectionEdge";
  /**
   * A cursor for use in pagination
   */
  cursor?: Maybe<ScalarsEnums["String"]>;
...
/**
 * The payload for the updateItsnzSpeaker mutation
 */
export interface UpdateItsnzSpeakerPayload {
  __typename?: "UpdateItsnzSpeakerPayload";
  /**
   * If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions.
   */
  clientMutationId?: Maybe<ScalarsEnums["String"]>;
...
export interface User {
  ...
  /**
   * Connection between the User type and the event type
   */
  events: (args?: {
    /**
     * Cursor used along with the "first" argument to reference where in the dataset to get data
  ...
  isTermNode: ScalarsEnums["Boolean"];
  /**
   * Connection between the User type and the itsnzSpeaker type
   */
  itsnzSpeakers: (args?: {
    /**
     * Cursor used along with the "first" argument to reference where in the dataset to get data
     ...
     * Arguments for filtering the connection
     */
    where?: Maybe<UserToItsnzSpeakerConnectionWhereArgs>;
  }) => Maybe<UserToItsnzSpeakerConnection>;
  /**
 ...
 * Connection between the User type and the event type
 */
export interface UserToEventConnection {
 ...
 * An edge in a connection
 */
export interface UserToEventConnectionEdge {
 ...
 * Connection between the User type and the itsnzSpeaker type
 */
export interface UserToItsnzSpeakerConnection {
  __typename?: "UserToItsnzSpeakerConnection";
  /**
   * Edges for the UserToItsnzSpeakerConnection connection
   */
  edges?: Maybe<Array<Maybe<UserToItsnzSpeakerConnectionEdge>>>;
  /**
   * The nodes of the connection, without the edges
   */
  nodes?: Maybe<Array<Maybe<ItsnzSpeaker>>>;
 ...
 * An edge in a connection
 */
export interface UserToItsnzSpeakerConnectionEdge {
  __typename?: "UserToItsnzSpeakerConnectionEdge";
  /**
   * A cursor for use in pagination
   */
  cursor?: Maybe<ScalarsEnums["String"]>;
...
export interface Mutation {
  ...
  createEvent: (args: { input: CreateEventInput }) => Maybe<CreateEventPayload>;
  createItsnzSpeaker: (args: {
    input: CreateItsnzSpeakerInput;
  }) => Maybe<CreateItsnzSpeakerPayload>;
  ...
  deleteEvent: (args: { input: DeleteEventInput }) => Maybe<DeleteEventPayload>;
  deleteItsnzSpeaker: (args: {
    input: DeleteItsnzSpeakerInput;
  }) => Maybe<DeleteItsnzSpeakerPayload>;
  ...
  updateEvent: (args: { input: UpdateEventInput }) => Maybe<UpdateEventPayload>;
  updateItsnzSpeaker: (args: {
    input: UpdateItsnzSpeakerInput;
  }) => Maybe<UpdateItsnzSpeakerPayload>;
...
export interface Query {
  ...
  }) => Maybe<RootQueryToEventConnection>;
  generalSettings?: Maybe<GeneralSettings>;
  itsnzSpeaker: (args: {
    asPreview?: Maybe<Scalars["Boolean"]>;
    id: Scalars["ID"];
    idType?: Maybe<ItsnzSpeakerIdType>;
  }) => Maybe<ItsnzSpeaker>;
  itsnzSpeakerBy: (args?: {
    id?: Maybe<Scalars["ID"]>;
    itsnzSpeakerId?: Maybe<Scalars["Int"]>;
    slug?: Maybe<Scalars["String"]>;
    uri?: Maybe<Scalars["String"]>;
  }) => Maybe<ItsnzSpeaker>;
  itsnzSpeakers: (args?: {
    ...
    first?: Maybe<Scalars["Int"]>;
    last?: Maybe<Scalars["Int"]>;
    where?: Maybe<RootQueryToItsnzSpeakerConnectionWhereArgs>;
  }) => Maybe<RootQueryToItsnzSpeakerConnection>;
  mediaItem: (args: {
    asPreview?: Maybe<Scalars["Boolean"]>;
    id: Scalars["ID"];
...
export interface SchemaObjectTypes {
  ...
  CreateItsnzSpeakerPayload: CreateItsnzSpeakerPayload;
  ...
  DeleteItsnzSpeakerPayload: DeleteItsnzSpeakerPayload;
  ...
  Event: Event;
  EventToItsnzSpeakerConnection: EventToItsnzSpeakerConnection;
  EventToItsnzSpeakerConnectionEdge: EventToItsnzSpeakerConnectionEdge;
  EventToPreviewConnectionEdge: EventToPreviewConnectionEdge;
  ...
  ItsnzSpeaker: ItsnzSpeaker;
  ItsnzSpeakerToPreviewConnectionEdge: ItsnzSpeakerToPreviewConnectionEdge;
  ...
  RootQueryToEventConnection: RootQueryToEventConnection;
  RootQueryToEventConnectionEdge: RootQueryToEventConnectionEdge;
  RootQueryToItsnzSpeakerConnection: RootQueryToItsnzSpeakerConnection;
  RootQueryToItsnzSpeakerConnectionEdge: RootQueryToItsnzSpeakerConnectionEdge;
  ...
  UpdateItsnzSpeakerPayload: UpdateItsnzSpeakerPayload;
  ...
  UserToEventConnection: UserToEventConnection;
  UserToEventConnectionEdge: UserToEventConnectionEdge;
  UserToItsnzSpeakerConnection: UserToItsnzSpeakerConnection;
  UserToItsnzSpeakerConnectionEdge: UserToItsnzSpeakerConnectionEdge;
...
export interface ScalarsEnums extends MakeNullable<Scalars> {
  ...
  EventIdType: EventIdType | undefined;
  ItsnzSpeakerIdType: ItsnzSpeakerIdType | undefined;
